...
Course coordinator : Goran Frehse

The ENSTA IN102 course, presented on the dedicated page [here](https://perso.ensta.fr/~frehse/in102web), aims to provide students with a comprehensive and progressive introduction to C programming. The course is part of a broader computer science program in the first year of engineering school, alongside modules on algorithms and data structures, and aims to provide students with the necessary foundations for rigorous, efficient programming.
